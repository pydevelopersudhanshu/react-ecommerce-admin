...
const CategoryLevel3Listing = () => {
    ...
    let breadCrumbPath = [
        ...
        { name: 'Sub-Sub-Category list', url: ``, active: 'not-allowed' },
    ]
                                                        ...
                                                        {state?.data?.data?.map((res, index) =>
                                                            <tr key={res._id}>
                                                                ...
                                                                <td><div className="btn-group gap-2">
                                                                    ...
                                                                    <Link className="btn btn-white btn-sm" to={`/category/level-3/edit/${res.name}/${res?._id}`}> <i className="fa fa-pencil me-1"></i>Edit</Link>
